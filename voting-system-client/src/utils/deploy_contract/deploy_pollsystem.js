...
import web3 from '../web3_config';
import PollSystem from '../contracts_info/pollsystem.json';

const bytecode = PollSystem.bytecode;

const abi = PollSystem.abi;
...
async function deploy(){
    ...
    const nonce = await web3.eth.getTransactionCount(defaultAccount, 'latest');
      ...
      nonce: `0x${nonce.toString(16)}`
        ...
        localStorage.setItem('pollsystemContractAddress', tx.options.address);
